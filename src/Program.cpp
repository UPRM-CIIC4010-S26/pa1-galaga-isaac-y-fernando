...
void Program::Update() {
    ...
    for (int i = 0; i < (int)Animation::animations.size();) {
...
void Program::Draw() {
    ...
    for (int i = 0; i < lives; i++) {
        DrawTexturePro(
            ...
            Rectangle{0, 0, 17, 18},
            Rectangle{10.0f + i * 30.0f, GetScreenHeight() - 30.0f, 20, 20},
            Vector2{0, 0},
            0,
            WHITE
        );
    ...
    DrawText(TextFormat("Score: %i", score), GetScreenWidth() - 200, 10, 30, WHITE);
